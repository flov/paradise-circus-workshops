...
export async function cleanupDatabase() {
  ...
  try {
    ...
    try {
      ...
      console.warn('Error deleting test data (this is usually fine):', deleteError)
    }
  }
}
...
export async function createTestEvent(overrides: Partial<typeof schema.events.$inferInsert> = {}) {
  const db = getTestDb()
